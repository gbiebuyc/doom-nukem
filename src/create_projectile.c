...
void	set_projectile_id(t_data *d, short i, short id_of_proj_type)
{
	...
	d->projectiles[i].dir.z = d->cam.cos * d->projectile_type[id_of_proj_type].speed;
	d->projectiles[i].dir.y = d->cam.y_offset * Y_OFFSET_TO_ROT * d->projectile_type[id_of_proj_type].speed;
	d->projectiles[i].dir.x = d->cam.sin * d->projectile_type[id_of_proj_type].speed;
...
void	set_projectile_id_monster(t_data *d, short i, short id_of_proj_type, t_monster *monster)
{
	d->projectiles[i].is_active = true;
	d->projectiles[i].id_type = id_of_proj_type;
	d->projectiles[i].pos = (t_vec3f){
		...
		monster->pos.y};
	d->projectiles[i].dir.z = sin(monster->rot) * d->projectile_type[id_of_proj_type].speed;
	d->projectiles[i].dir.y = (d->cam.pos.y - (d->sectors[monster->cursectnum].floorheight + 0.8)) / vec3f_length(sub_vec3f(d->projectiles[i].pos, d->cam.pos)) * d->projectile_type[id_of_proj_type].speed;
