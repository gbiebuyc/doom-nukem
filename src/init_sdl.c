...
/********************/
	...
	// 5 orientation of animation 1 A    d->monster_text[monster_name][letter_of_annimation][num_of_orientation];
	...
	// // 5 orientation of animation 2 B
	...
	// // 5 orientation of animation 3 C
	// d->monster_text[MOTHERDEMON][2][0] = d->monster_text[MOTHERDEMON][0][0]; //  d->monster_text[MOTHERDEMON][2][0];
	// d->monster_text[MOTHERDEMON][2][1] = d->monster_text[MOTHERDEMON][0][1]; //  d->monster_text[MOTHERDEMON][2][1];
	// d->monster_text[MOTHERDEMON][2][2] = d->monster_text[MOTHERDEMON][0][2]; //  d->monster_text[MOTHERDEMON][2][2];
	// d->monster_text[MOTHERDEMON][2][3] = d->monster_text[MOTHERDEMON][0][3];//  d->monster_text[MOTHERDEMON][2][3];
	// d->monster_text[MOTHERDEMON][2][4] = d->monster_text[MOTHERDEMON][0][4];//  d->monster_text[MOTHERDEMON][2][4];
	// // 5 orientation of animation 4 D
